    ...
    return (
        <Cointainer>
            <Left>
                ...
                <Desc>Manufacturer of all type of liquids , detergent powder & cake ,oil soap ,checmical trading in DHAMPUR</Desc>
                <SocialCointainer>
            ...
            <Title>Contact</Title>
                <ContactItem>
                    <Room style={{marginRight:"10px"}}/>GURUNANAK GRAM UDYOG SEWA SANTHAN , 2KM MILE STONE NAGINA ROAD DHAMPUR, Uttar Pradesh 246761, India
                </ContactItem>
                <ContactItem>
